...
public class EditUserAcademics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_user_academics);
        ...
        toolbar=findViewById(R.id.toolbar_edit_user_academics);
